...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(errs).length === 0) {
      try {
        ...
        if (!res.ok) {
          setApiError(data.errors?.[0]?.msg || 'Sign up failed');
        } else {
  ...
  return (
    <div className={styles.container}>
      ...
      <Box component="img" src={process.env.PUBLIC_URL + '/Ellipse1.png'} alt="ellipse1" className={styles.ellipse1} />
      <Box component="img" src={process.env.PUBLIC_URL + '/Ellipse2.png'} alt="ellipse2" className={styles.ellipse2} />
      <Box component="img" src={process.env.PUBLIC_URL + '/Ellipse3.png'} alt="ellipse3" className={styles.ellipse3} />

      {/* Left Section */}
      <div className={styles.leftSection}>
        <Box component="img" src={process.env.PUBLIC_URL + '/logo.png'} alt="Lemonpay Logo" className={styles.logo} />
      ...
      <div className={styles.rightSection}>
        <div className={styles.formContainer}>
          <div className={styles.formHeader}>
            <h2 className={styles.formTitle}>Welcome Sign Up System</h2>
          ...
          <Box component="form" className={styles.form} onSubmit={handleSubmit} noValidate>
            ...
            <div className={styles.inputGroup}>
              ...
              <TextField
                ...
                onChange={handleChange}
                error={!!errors.confirmPassword && submitted}
                InputProps={{
                  sx: {
                    background: '#E6E1FAA3',
                    borderRadius: '8px',
              ...
              {errors.confirmPassword && submitted && (
                <span style={{ color: '#FF6B6B', fontSize: 13, marginTop: 2 }}>{errors.confirmPassword}</span>
              )}
            </div>
